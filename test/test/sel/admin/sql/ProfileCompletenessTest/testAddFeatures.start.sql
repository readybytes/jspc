...
(4, 'avatar', 'Avtar', 'jspc_core_total_contribution=100\njspc_core_display_text=%s Avtar\njspc_profiletype=0\n\n', '\n', 1),
(5, 'groupowner', 'Group Member', 'jspc_core_total_contribution=100\njspc_core_display_text=%s Group Member\njspc_profiletype=0\n\n', 'groupowner_total=10\n\n', 1),
(6, 'photos', 'Photos', 'jspc_core_total_contribution=100\njspc_core_display_text=%s Photos\njspc_profiletype=0\n\n', 'photo_total=10\n\n', 1),
(7, 'videos', 'Videos', 'jspc_core_total_contribution=100\njspc_core_display_text=%s Videos\njspc_profiletype=0\n\n', 'video_total=10\n\n', 1);
